...
class ctrScriptMan {
    ...
    __New(*) {
        ...
        this.Menu.Command.Add('Bundle content', (*) => this.StdOut.CMD.Run('python -u bundle_content.py'))
        ...
        this.Menu.Macro.Add('Make a test build with new assets', (*) => this.StdOut.CMD.Run('python -u bundle_content.py', , (*) => this.StdOut.CMD.Run('dotnet build -f net10.0', A_ScriptDir '\..')))
